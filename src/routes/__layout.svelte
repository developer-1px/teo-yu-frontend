...
<div class="hbox font(20) p(20) gap(20) bold .isUp:sticky-top bg(#fff) z(99999)" class:isUp>
  <div>테오의 프론트엔드</div>
  <a class="hover:underline pointer .active:bb(4px/hsl(100,75%,75%))" href="/" use:useActive>#Link</a>
  <a class="hover:underline pointer .active:bb(4px/hsl(100,75%,75%))" href="/talk" use:useActive>#Talk</a>
  <div class="flex"></div>
